---
title: "fastFlow_cytometrySummary"
author: "MLB"
date: "11/19/2020"
...
#cleanFlow
pilot testing, has now been split into cleanFlow and calcFlow
```{r warning=FALSE}
test_dat = read_excel("../19-062.xls", col_names = F)
...
#TODO: R doesn't like the "Events / μL" name. We'll need to generalize this, but for now I've hard coded it, as the input data frame is still in development
...
test_dat = read_excel("../test_batch_analysis.xlsx",col_names = F)
# test_dat = read_excel("../19-062.xls",col_names = F)
# cleanFlow_0.2(test_dat,"TIA_rep1")[[1]]
